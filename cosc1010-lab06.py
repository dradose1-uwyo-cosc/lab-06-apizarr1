...
# Lab 06
# Lab Section 18 
# Sources, people worked with, help given to: w3schools.com
...
most_occurred_char = sorted_keys[0]
least_occured_char = sorted_keys[0]

for char in sorted_keys:
    if char_count[char] > char_count[most_occurred_char]:
        most_occurred_char = char

    if char_count[char] < char_count[least_occured_char]:
        least_occured_char = char
    
print("*" * 75)
print(f"The letter that occured the most is '{most_occurred_char}' with {char_count[most_occurred_char]} occurrences.")
print("*" * 75)
print(f"The letter that occured the least is '{least_occured_char}' with {char_count[least_occured_char]} occurrences.")
print("*" * 75)

for char in sorted_keys:
    percentage = (char_count[char] / total_chars) * 100
